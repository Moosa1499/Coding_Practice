...
If the calling line includes a value for the 
number of tracks, add that value to the album’s Object. 
...
// Examples :
const album1 = make_album('Artist 1','Album 4');

const album2 = make_album('Artist 4','Album 2',12);

const album3 = make_album('Artist 9','Album 12',6);
